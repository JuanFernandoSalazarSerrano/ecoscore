...
def draw_header():
	screen.draw_circle(x=55, y=70, r=18, bcolor=EMERALD, fcolor=EMERALD)
	...
	screen.draw_text(text="ACCEL", x=82, y=84, font_size=10, color=TEAL)


def draw_sensor_boxes():
	screen.draw_rect(x=40, y=120, w=160, h=32, bcolor=0xDDF8EA, fcolor=0xDDF8EA)
	screen.draw_rect(x=40, y=165, w=160, h=32, bcolor=0xDDF8EA, fcolor=0xDDF8EA)
	screen.draw_rect(x=40, y=210, w=160, h=32, bcolor=0xDDF8EA, fcolor=0xDDF8EA)
...
def run():
	...
	while True:
		...
		screen.draw_text(text="X: " + str(x), x=55, y=126, font_size=18, color=DEEP_GREEN)
		screen.draw_text(text="Y: " + str(y), x=55, y=171, font_size=18, color=TEAL)
		screen.draw_text(text="Z: " + str(z), x=55, y=216, font_size=18, color=DEEP_GREEN)
