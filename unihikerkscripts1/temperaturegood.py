...
def draw_header():
    ...
    screen.draw_text(text="TEMPERATURE", x=82, y=84, font_size=10, color=TEAL)
...
while True:
    ...
    draw_value_box()
    screen.draw_text(text="T: " + str(temp_c) + " C", x=55, y=152, font_size=18, color=DEEP_GREEN)
    screen.draw_text(text=str(temp_f) + " F", x=145, y=152, font_size=18, color=TEAL)
